(() => {
  ...
  function setupMusic() {
    ...
    // Browsers block autoplay until the guest taps anywhere — start on first touch
    ...
    document.addEventListener("touchstart", startOnInteraction, { once: false, passive: true });
  }
